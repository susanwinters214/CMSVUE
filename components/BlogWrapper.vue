          ...
          <div class="blog-content-column">
            <div class="blog-content-area post-items-style2">
              ...
              >
                ...
                <div class="content">
                  <div class="meta">
                    <NuxtLink to="/blog" class="post-date">{{
                      blog.date
                    }}</NuxtLink>
                    <NuxtLink to="/blog" class="post-comment"
                      ><i class="icofont-speech-comments"></i
                      >{{ blog.comment }}</NuxtLink
                    >
                    <NuxtLink to="/blog" class="post-like"
                      ><i class="icofont-heart"></i>{{ blog.like }}</NuxtLink
                    >
                    <NuxtLink to="/blog" class="post-author"
                      ><i class="icofont-user-alt-7"></i
                      >{{ blog.author }}</NuxtLink
                    >
                  </div>
                  <h4 class="title">
      ...
      blogs: [
        {
          ...
          excerpt:
            "Lorem Ipsum is simply dummy text the printing and typesetting industry lorem ipsum has industry' standard dummy text ever since the 1500s, whean an unknown printer took galle scrambled it to make a type specimen.",
          date: "21 March, 2021",
          comment: 2566,
          like: 750,
          author: "Alvin Malone",
