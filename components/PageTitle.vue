  ...
  >
        ...
        <div class="col-lg-12">
          <div class="page-title-content">
            ...
            <div class="bread-crumbs">
              <img
                class="line-shape"
                src="/images/shape/line-s3.png"
                alt="shape"
              />
              <NuxtLink to="/">
                Home <span class="breadcrumb-sep">/</span></NuxtLink
              >
    ...
    <div class="page-sidebar" data-aos="fade-right" data-aos-duration="1100">
      <div class="social-icon">
        <a href="https://facebook.com/cybermediastudio.com"
          ><i class="icofont-facebook"></i
        ></a>
        <a href="https://instagram.com/cybermediastudio.com"
          ><i class="icofont-instagram"></i
        ></a>
        <a href="https://youtube.com/@cybermediastudio.com"
