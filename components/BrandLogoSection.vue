            ...
            <div class="row">
                <div class="col-lg-5 col-xl-5">
                    <div class="section-title xs-text-center" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h2 class="title text-white mb-lg-40 mb-80">We can create your <span>Logo</span></h2>
                        <a href="/contact" class="btn btn-theme btn-border">Contact<i class="icon icofont-long-arrow-right"></i></a>
                    </div>
                </div>
