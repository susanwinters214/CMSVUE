  ...
  <section class="portfolio-area portfolio-default-area">
      ...
      >
        <div class="col-sm-8">
          <div class="section-title xs-text-center">
            ...
            <h2 class="title">
              We Have Leadership Strong Experience In <span>Business.</span>
            </h2>
          </div>
        </div>
        <div class="col-sm-4 text-right">
          <NuxtLink
            ...
            >All Projects <i class="icon icofont-long-arrow-right"></i
          ></NuxtLink>
        </div>
      </div>
    </div>
    <div class="container custom-container">
      <div class="row">
        <div class="col-lg-12">
          <div
            class="portfolio-slider-content"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div class="swiper-container portfolio-slider-container">
              <swiper
                ...
                :breakpoints="portfolioSliderContainer.breakpoints"
                :loop="true"
              >
                <swiper-slide class="portfolio-item">
                  <div class="inner-content">
                    <div
                      class="thumb"
                      :style="{
                        backgroundImage: `url('/images/portfolio/s2.jpg')`,
                      }"
                    >
                      <NuxtLink to="/project-details"></NuxtLink>
                    </div>
                    <div class="portfolio-info">
                      <div class="content">
                        ...
                        <NuxtLink to="/project-details" class="category"
                ...
                <swiper-slide class="portfolio-item">
                  <div class="inner-content">
                    <div
                      class="thumb"
                      :style="{
                        backgroundImage: `url('/images/portfolio/s3.jpg')`,
                      }"
                    >
                      <NuxtLink to="/project-details"></NuxtLink>
                    </div>
                    <div class="portfolio-info">
                      <div class="content">
                        ...
                        <h3 class="title">
                          <NuxtLink to="/project-details"
                            >Market Statics & Analysis.</NuxtLink
                          >
                        </h3>
                        <NuxtLink to="/project-details" class="category"
                          >Business / Marketing</NuxtLink
                ...
                <swiper-slide class="portfolio-item">
                  <div class="inner-content">
                    <div
                      class="thumb"
                      :style="{
                        backgroundImage: `url('/images/portfolio/s1.jpg')`,
                      }"
                    >
                      <NuxtLink to="/project-details"></NuxtLink>
                    </div>
